...
changeCostScene.action(actions.CANCEL, (ctx) => {
...
changeCostScene.action(actions.CHANGE_SUBJECT, (ctx) => {
    return ctx.scene.enter(scenes.CHANGE_SUBJECT);
});

changeCostScene.action(actions.CHANGE_CATEGORY, (ctx) => {
    return ctx.scene.enter(scenes.CHANGE_CATEGORY);
});

changeCostScene.action(actions.CHANGE_MONTH, (ctx) => {
    return ctx.scene.enter(scenes.CHANGE_MONTH);
});
